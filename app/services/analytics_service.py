...
EVENT_SCHEMA: dict[str, tuple[str, list[str]]] = {
    ...
    "recommendation_shown": ("producto", []),
    "recommendation_accepted": ("producto", []),
    "recommendation_rejected": ("producto", []),
    "segment_override": ("producto", []),
    "nav_error": ("producto", ["pantalla"]),
    # v4 · experiencia universal (nombres canónicos + los que emite el cliente)
    "runi_mode_selected": ("producto", []),
    "relationship_set": ("producto", []),
    "faculty_pack_resolved": ("producto", []),
    "runi_intervention_shown": ("producto", []),
    "reward_moment_shown": ("producto", []),
    "medal_unlocked": ("aprendizaje", []),
    "accessory_set": ("identidad", []),
    "peer_support_validated": ("aprendizaje", []),
    "student_fatigue_signal": ("producto", []),
    "privacy_setting_changed": ("seguridad", []),
    "learning_episode_started": ("aprendizaje", []),
    "learning_episode_verified": ("aprendizaje", []),
